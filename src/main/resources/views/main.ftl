...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll layui-left-menu">
            <!-- 判断当前用户是否拥有权限 -->
            <#if permissions??><!-- 该指令判断该参数是否存在，存在的话，标签内的内容生效 -->
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                    <!-- 通过 freemarker 中的内建指令判断菜单是否显示 -->
                    <!-- 营销管理 -->
                    <#if permissions?seq_contains("10")><!-- 传递来的参数序列是否包含 10  -->
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <#if permissions?seq_contains("1020")>
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                           data-tab-mpi="m-p-i-2" data-tab="cusDev/index" target="_self"><i
                                ...
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       ...
                                       data-tab="report/3" target="_self"><i class="fa fa-tachometer"></i><span
                                                class="layui-left-nav"> 客户类别分析</span></a>
                                </dd>
                                </#if>
                            </dl>
                        </li>
